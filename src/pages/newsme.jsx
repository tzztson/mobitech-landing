        ...
        <div className="">
            ...
            <div className='flex container mx-auto my-12 justify-between gap-8 px-12 max-[1030px]:flex-col max-md:px-4'>
                <div className='flex flex-col flex-[1_1_50%]'>
                    ...
                    <button className='mt-24 bg-[#6BA1F2] rounded-[50px] px-28 max-sm:px-12 max-sm:py-2 py-6 font-[inter] text-[30px] font-medium w-[360px] max-sm:w-full'>Download</button>
                </div>
